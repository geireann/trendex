import { Sport, AthleteType} from "../global";
...
export const athletes = [
    ...
    new AthleteType(
      '8',
      Sport.TENNIS,
      "https://media.cnn.com/api/v1/images/stellar/prod/230119171019-andy-murray-thanasi-kokkinakis.jpg?c=original",
      'Andy Murray',
      21.4,
      0
    ),
    new AthleteType(
      '9',
      Sport.TENNIS,
      "https://static.independent.co.uk/2022/10/20/10/6b487b5b54feb09c607af250a5a3bf00Y29udGVudHNlYXJjaGFwaSwxNjY2MzQyOTUw-2.69320685.jpg?width=1200",
      'Coco Gauff',
      19.7,
      0
    ),
