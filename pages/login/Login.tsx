        ...
        <Button
          ...
          onPress={() => {
            createUser({
              ...
              email: email,
              balance: 100,
              tokens: [new TokenType("4", "Lebron James", 1, 10, "", Sport.BASKETBALL), 
                      new TokenType("5", "Robert Lewandowski", 2, 18, "", Sport.FOOTBALL),
                      new TokenType("6", "Kylian Mbappe", 3, 60, "", Sport.FOOTBALL)
                    ]
            })
